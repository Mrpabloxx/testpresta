...
class ReferenciaView(View):
    ...
    def post(self, request):
        ...
        referencia = Referencia.objects.create(
            personales_exists=jd['personales_exists'],
            crediticias_exists=jd['crediticias_exists'],
            bancarias_exists=jd['bancarias_exists'],
            laborales_exists=jd['laborales_exists'],
